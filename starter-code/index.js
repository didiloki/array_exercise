...
exports.productArray = function () {
    ...
    //write code here
    let result = 1;
    result = numbers.reduce(function (prev = result, current) {
        return prev * current;
    })
...
exports.averageWords = function () {
    ...
    result = lengths.reduce(function (avg = result, current, index) {
        // return  (index * avg + current ) / (index + 1)
...
exports.uniquifyArray = function () {
    ...
    // Your code here
    let result = words.filter(function(word, index){
...
exports.greatestSumMulti = function () {
    ...
    matrix.forEach(function(arr){
        sum = 0;
        sum = arr.reduce(function(prev = 0, current){
            return prev + current;
        })
        greatestSum = sum > greatestSum ? sum : greatestSum
    })
    let result = greatestSum
